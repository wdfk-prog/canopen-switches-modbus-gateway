...
| 寄存器种类 | 读取地址    | 数据类型   | 参数范围    | 默认值 | 备注           |
| ---------- | ----------- | ---------- | ----------- | ------ | -------------- |
| 输入寄存器 | 0X03~0X0B   | string     | 无          | 无     | 查看节点名称   |
| 输入寄存器 | 0X03        | string     | 无          | 无     | 节点名称开始   |
| ........   | ........... | .......... | ........... | .....  | 节点名称中间值 |
| 输入寄存器 | 0X06        | string     | 无          | 无     | 节点名称结束   |
...
| 寄存器种类 | 读取地址 | 数据类型 | 参数范围 | 默认值 | 备注             |
| ---- | ---- | ---- | ---- | ---- | ---- |
| 保持寄存器 | 0X01 | uint16 | 0~128 | 1~节点数[1.1.2查看节点数](#1.1.2查看节点数) | 设置需操作的节点ID |
| 保持寄存器 | 0X02~0X0A | uint16   | ... | ... | CAN保留区域 |
| 保持寄存器 | 0X0B | uint16 | 1~8 | 0 | 电机模式设置       |
|      |      |      |      |      |      |
|      |      |      |      |      |      |
|      |      |      |      |      |      |
|      |      |      |      |      |      |
