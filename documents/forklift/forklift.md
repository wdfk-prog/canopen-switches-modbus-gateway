...
- 设置电机速度，单位:RPM,默认值60RPM,范围：0~2000

| 保持寄存器地址 | 数据类型 | 参数范围 | 默认值 | 备注                         |
| -------------- | -------- | -------- | ------ | ---------------------------- |
| 39D            | uint16   | 0~2000   | 60     | 转向电机[1]速度输入 单位:RPM |
| 40D            | uint16   | 0~2000   | 60     | 转向电机[2]速度输入 单位:RPM |
| 41D            | uint16   | 0~2000   | 60     | 转向电机[3]速度输入 单位:RPM |
| 42D            | uint16   | 0~2000   | 60     | 转向电机[4]速度输入 单位:RPM |
...
| 输入寄存器地址 | 数据类型 | 参数范围 | 默认值 | 备注                         |
| -------------- | -------- | -------- | ------ | ---------------------------- |
| 59D            | uint16   | 0~2000   | 0      | 转向电机[1]反馈速度 单位:RPM |
| 60D            | uint16   | 0~2000   | 0      | 转向电机[2]反馈速度 单位:RPM |
| 61D            | uint16   | 0~2000   | 0      | 转向电机[3]反馈速度 单位:RPM |
| 62D            | uint16   | 0~2000   | 0      | 转向电机[4]反馈速度 单位:RPM |
