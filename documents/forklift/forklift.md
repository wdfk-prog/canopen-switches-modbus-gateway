...
- 角度范围默认-180~180度，超出角度范围将只能运动到最大角度范围，并反馈角度超出范围标志。[2.3.3 转向电机角度超出范围标志查询](#2.3.3 转向电机角度超出范围标志查询)。可通过设置角度范围调整[2.2.3 转向电机角度范围设置](#2.2.3 转向电机角度范围设置)。

| 保持寄存器地址 | 数据类型 | 参数范围 | 默认值       | 备注                            |
| -------------- | -------- | -------- | ------------ | ------------------------------- |
| 51D~52D        | float    | -180~180 | 当前反馈角度 | 转向电机[1]角度输入 单位:0.001° |
| 53D~54D        | float    | -180~180 | 当前反馈角度 | 转向电机[2]角度输入 单位:0.001° |
| 55D~56D        | float    | -180~180 | 当前反馈角度 | 转向电机[3]角度输入 单位:0.001° |
| 57D~58D        | float    | -180~180 | 当前反馈角度 | 转向电机[4]角度输入 单位:0.001° |
...
| 保持寄存器地址 | 数据类型 | 参数范围 | 默认值 | 备注                            |
| -------------- | -------- | -------- | ------ | ------------------------------- |
| 59D            | uint16   | 0~20000  | 600    | 转向电机[1]速度输入 单位:0.1RPM |
| 60D            | uint16   | 0~20000  | 600    | 转向电机[2]速度输入 单位:0.1RPM |
| 61D            | uint16   | 0~20000  | 600    | 转向电机[3]速度输入 单位:0.1RPM |
| 62D            | uint16   | 0~20000  | 600    | 转向电机[4]速度输入 单位:0.1RPM |
...
| 保持寄存器地址 | 数据类型 | 参数范围 | 默认值 | 备注                       |
| -------------- | -------- | -------- | ------ | -------------------------- |
| 63D            | int16    | 无       | 180    | 转向电机[1]最大角度 单位:° |
| 64D            | int16    | 无       | -180   | 转向电机[1]最小角度 单位:° |
| 65D            | int16    | 无       | 180    | 转向电机[2]最大角度 单位:° |
| 66D            | int16    | 无       | -180   | 转向电机[2]最小角度 单位:° |
| 67D            | int16    | 无       | 180    | 转向电机[3]最大角度 单位:° |
| 68D            | int16    | 无       | -180   | 转向电机[3]最小角度 单位:° |
| 69D            | int16    | 无       | 180    | 转向电机[4]最大角度 单位:° |
| 70D            | int16    | 无       | -180   | 转向电机[4]最小角度 单位:° |
